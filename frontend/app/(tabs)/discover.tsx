...
import { calculateWidth, DiscoverCard, DiscoverCardImage } from "@/lib";
...
export default function Discover() {
  ...
  const styles = useMemo(() => {
    return StyleSheet.create({
      ...
      discoverImage: {
        width: calculateWidth(width, 310),
        height: calculateWidth(width, 173),
        flexShrink: 0,
  ...
  return (
    <ScrollView style={styles.discover}>
      ...
      <TouchableOpacity
        onPress={() => router.push("/(appbar)/promotion_detail")}
      >
        <View style={styles.discoverCard}>
          <DiscoverCard style={styles.discoverBack} />
          <DiscoverCardImage
